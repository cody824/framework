...
public class FileUtil {
	private static final String DEFAULT_BASE_PATH = "/mnt/sure/yb";
	...
	public static String fileUpload(HttpServletRequest request, String fileKeyName,
		...
		String fileDir = basePath + UPLOAD_DIR + userName + "/" + module + "/" + fileType + "/";
		String upDir = UPLOAD_DIR + userName + "/" + module + "/" + fileType + "/";
	...
	public static String getFileName(String type, String prefix, String suffix) {
		//当前时间
		String date = DateUtil.getCurrentTime("yyyyMMddHH24mmss");
		//10位随机数
