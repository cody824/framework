...
public class ExcelReadHelper {
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public static List<Object> excelRead(File file, String[] properties, Class obj, Integer sheetNum) throws Exception {
		Workbook book = null;
		try {
			book = new XSSFWorkbook(new FileInputStream(file));     //解析2003
		} catch (Exception e) {
		...
		return getExcelContent(book, properties, obj, sheetNum);
	}
	 ...
	 * @throws Exception
	 */
	public static List<String> excelReadSheetName(File file) throws Exception {
		Workbook book = null;
	...
	@SuppressWarnings("rawtypes")
	private static List<Object> getExcelContent(Workbook book, String[] properties,
	                                            Class obj, Integer sheetNum) throws Exception {
		List<Object> resultList = new ArrayList<Object>();        //初始化结果解
		Map<String, Method> methodMap = getObjectSetterMethod(obj);
		Map<String, Field> fieldMap = getObjectField(obj);
	...
	private static Object getObject(Row row, String[] properties,
		...
		for (int numCell = 0; numCell < properties.length; numCell++) {
	...
	private static void setObjectPropertyValue(Object obj, Field field,
		...
		if ("java.lang.String".equals(type) || "String".equals(type)) {
			oo[0] = value;
		} else if ("java.io.Serializable".equals(type) || "java.lang.Integer".equals(type) || "java.lang.int".equals(type) || "Integer".equals(type) || "int".equals(type)) {
			if (value.length() > 0) {
			...
			if (value.length() > 0) {
				oo[0] = DateUtil.formatDate(value, "yyyyMMddHH24mmss");
			}
