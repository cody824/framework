...
public class VerificationCodeController extends BaseController {
	...
	private static final int OBSTRUCT = 155;
	...
	@Autowired
	public VerificationCodeController(VerificationCodeService verificationCodeService, CacheService cacheService) {
	...
	Object generatePhotoAuthcode(
		...
		return ResponseEntity.ok().body(new HashMap<>(0));
	...
	public void generateImgAuthcode(HttpServletRequest request,
		...
		// 取随机产生的认证码(4位数字)
		StringBuilder aRand = new StringBuilder();
		try {
			aRand = new StringBuilder(verificationCodeService.generate(clientId, len, timeout));
